...
const Table = (props) => {
    ...
    const handleChange =(async event => {
        ...
        try {
            const res = await axios.get('https://onlinetutoring.azurewebsites.net/Teachers/GetAllTeacher?searchTerm='+searchTerm);
            debugger;
            setCourses(res.data);
        } catch (ex) {
            setCourses(null);
    ...
    function handleToken(data){  
        ...
        const res =  axios.post('https://onlinetutoring.azurewebsites.net/Students/StudentPayment', formData);
        debugger;
        if(res){
